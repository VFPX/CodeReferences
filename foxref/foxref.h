...
#define PROPERTYNAME_LOC		"<Property Def>"
#define METHODNAME_LOC			"<Method Def>"
*** JRN 2010-03-15 : new ones
#define CLASSNAME_LOC			"<Class>"
#define CLASSDEF_LOC			"<Class Def>"
#define OBJECTDEF_LOC			"<Object>"
#define PRGNAME_LOC				"<PRG File>"
#define INCLUDENAME_LOC			"<Include File>"

#define PROPERTY_LOC			"<Property>"
#define METHOD_LOC				"<Method>"
#define PROCEDURE_LOC			"<Procedure>"
#define FUNCTION_LOC			"<Function>"
...
#define MNX_NAME_LOC				"<Menu Name>"
#define MNX_PROMPT_LOC				"<Menu Prompt>"
#define MNX_COMMAND_LOC				"<Menu Command>"
#define MNX_MESSAGE_LOC				"<Menu Message>"
#define MNX_PROCEDURE_LOC			"<Menu Procedure>"
#define MNX_SETUP_LOC				"<Menu Setup>"
#define MNX_CLEANUP_LOC				"<Menu Cleanup>"
#define MNX_SKIPFOR_LOC				"<Menu Skip For>"
#define MNX_RESOURCE_LOC			"<Menu Resource>"
#define MNX_COMMENT_LOC				"<Menu Comment>"
...
#define MENUSORT_FOLDER_LOC			"\<Folder"
#define MENUSORT_FILENAME_LOC		"File \<Name"
#define MENUSORT_EXTENSION_LOC		"E\<xtension"
#define MENUSORT_CLASS_LOC			"\<Class"
#define MENUSORT_METHOD_LOC			"\<Method"
#define MENUSORT_LINE_LOC			"\<Line"
#define MENUSORT_CODE_LOC			"Co\<de"
#define MENUSORT_TIMESTAMP_LOC		"\<TimeStamp"
...
*** JRN 2010-03-20 : list of chars handled specially by RegExp
#define RegExpSpecialChars 			".*+^[]()|\"
#define RESOURCE_FILE				Home(7) + "\Code_References_Resource_File.DBF"